...
export const CreateSaloon = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const payload = { ...salon, barbers: [user._id] };
      const response = await fetch(`${API}/api/salon`, {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        toast.error(res_data.message || "Could not create salon");
      }
    } catch (error) {
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-white/10 rounded-2xl shadow-lg shadow-purple-500/10 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">
              Make your barbershop discoverable. Enter your salon's details to
              get started!
            </p>
          </div>
